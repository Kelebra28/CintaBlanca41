...
// if(player1  === 'papel'  && player2 === 'papel' || player1  === 'tijera'  && player2 === 'tijera' || player1  === 'piedra'  && player2 === 'piedra'  ){
//     console.log('Empate')
...
// .floor --> regresa el entero
// .ramdom * 3 devuelve los numero 0, 1 , 2
// le sumamos 1 - 1, 2 ,3
...
if(genero === 'Trap'){
    musicaCool.push(genero)
    console.log('Musica Cool: ' + musicaCool)
}else{
    musicaNoCool.push(genero)
    console.log('Musica no Cool: ' + musicaNoCool)
}
